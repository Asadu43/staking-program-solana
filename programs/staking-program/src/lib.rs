...
declare_id!("E8XgZGvUxsUk9NWaT9KhVP5gidWXKvrrL4Z7Lb2zUnjf");
    ...
    pub fn stake(ctx: Context<Stake>, amount: u64) -> Result<()> {
        ...
        transfer(
            CpiContext::new(ctx.accounts.token_program.to_account_info(), Transfer {
                from: ctx.accounts.user_info_account.to_account_info(),
        ...
        transfer(
            CpiContext::new_with_signer(
                ...
                Transfer {
                    ...
                    to: ctx.accounts.user_info_account.to_account_info(),
...
pub struct Stake<'info> {
    ...
    pub user_info_account: Account<'info, TokenAccount>,
